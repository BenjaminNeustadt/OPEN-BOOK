mapboxgl.accessToken =
  "pk.eyJ1IjoiemVpbnp6dSIsImEiOiJjbDZpajJoejEwMDRjM2pqdHk5OTR3c3NtIn0.K39ZfeJfxbHD6mq_lKxmjw";
  ...
  const shops = something.data.map((shop) => {
    return {
      ...
      geometry: {
        type: "Point",
        coordinates: [
          shop.coordinates[0].$numberDecimal,
          shop.coordinates[1].$numberDecimal,
        ],
      },
      properties: {
        storeId: shop.name,
